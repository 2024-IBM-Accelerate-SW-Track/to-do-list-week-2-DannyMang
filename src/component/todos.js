      ...
      return (
        ...
        {/* Remember, we set the local state of this todo item when the user submits the form in 
          ...
          <ListItemButton component="a" href="#simple-list">
            <Checkbox style={{paddingLeft:0}} color={'primary'} onClick={() => deleteTodos(todo.id)}/>
          <ListItemText primary={todo.content} secondary={todo.date}/>
          <ListItemText primary="Pre-conditions" secondary={todo.preConditions}/>
          <ListItemText primary="Acceptance Criteria" secondary={todo.acceptanceCriteria}/>
          </ListItemButton>
          </Card>
          </Grid>
        );
